const translations = {
  ru: {
    ...
    project_ch_desc: "Красивый сайт для генерации цветовой палитры. Подойдёт как для игроков, так и для разработчиков и дизайнеров.",
  ...
  en: {
    ...
    project_ch_desc: "A beautiful site for generating color palettes. Suitable for both players and developers and designers.",
    project_mayson_name: "Mayson",
