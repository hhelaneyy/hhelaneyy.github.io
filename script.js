const translations = {
  ru: {
    ...
    project_pixel_name: "ColorHarmony",
    project_pixel_desc: "Красивый сайт для генерации цветовой палитры. Подойдёт как для игроков, так и для разработчиков и дизайнеров.",
  ...
  en: {
    ...
    project_pixel_name: "ColorHarmony",
    project_pixel_desc: "A beautiful site for generating color palettes. Suitable for both players and developers and designers.",
    project_mayson_name: "Mayson",
