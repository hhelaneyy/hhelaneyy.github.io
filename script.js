const translations = {
  ru: {
    ...
    home_desc: "Начинающий программист. Специализируюсь на создании простых Discord ботов и нетрудных программ.",
  ...
  en: {
    ...
    home_desc: "Beginner programmer. I specialize in creating simple Discord bots and easy programs.",
